...
// This function starts a new thread waiting for platform signals. Platform signals are processed one
// at a
...
// Main entry-point to the TCP server. The server listens on port specified. Note that there is
// no way to
