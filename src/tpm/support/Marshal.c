...
// Table 2:12 - Definition of (UINT32) TPM_CC Constants (EnumTable)
// TPM_CC_Unmarshal changed to #define
// TPM_CC_Marshal changed to #define

// Table 2:16 - Definition of (UINT32) TPM_RC Constants (EnumTable)
// TPM_RC_Unmarshal not required
// TPM_RC_Marshal changed to #define

// Table 2:17 - Definition of (INT8) TPM_CLOCK_ADJUST Constants (EnumTable)
TPM_RC
...
// Table 2:18 - Definition of (UINT16) TPM_EO Constants (EnumTable)
TPM_RC
TPM_EO_Unmarshal(
...
// Table 2:19 - Definition of (UINT16) TPM_ST Constants (EnumTable)
// TPM_ST_Unmarshal changed to #define
// TPM_ST_Marshal changed to #define

// Table 2:20 - Definition of (UINT16) TPM_SU Constants (EnumTable)
TPM_RC
TPM_SU_Unmarshal(
...
// Table 2:21 - Definition of (UINT8) TPM_SE Constants (EnumTable)
TPM_RC
TPM_SE_Unmarshal(
...
// Table 2:22 - Definition of (UINT32) TPM_CAP Constants (EnumTable)
TPM_RC
TPM_CAP_Unmarshal(
...
// Table 2:23 - Definition of (UINT32) TPM_PT Constants (EnumTable)
// TPM_PT_Unmarshal changed to #define
// TPM_PT_Marshal changed to #define

// Table 2:24 - Definition of (UINT32) TPM_PT_PCR Constants (EnumTable)
// TPM_PT_PCR_Unmarshal changed to #define
// TPM_PT_PCR_Marshal changed to #define

// Table 2:25 - Definition of (UINT32) TPM_PS Constants (EnumTable)
...
// Table 2:27 - Definition of (UINT8) TPM_HT Constants (EnumTable)
// TPM_HT_Unmarshal not required
// TPM_HT_Marshal not required

// Table 2:28 - Definition of (TPM_HANDLE) TPM_RH Constants (EnumTable)

// Table 2:29 - Definition of (TPM_HANDLE) TPM_HC Constants (EnumTable)

// Table 2:30 - Definition of (UINT32) TPMA_ALGORITHM Bits (BitsTable)
TPM_RC
...
// Table 2:31 - Definition of (UINT32) TPMA_OBJECT Bits (BitsTable)
TPM_RC
...
// Table 2:32 - Definition of (UINT8) TPMA_SESSION Bits (BitsTable)
TPM_RC
...
// Table 2:33 - Definition of (UINT8) TPMA_LOCALITY Bits (BitsTable)
// TPMA_LOCALITY_Unmarshal changed to #define
// TPMA_LOCALITY_Marshal changed to #define

// Table 2:34 - Definition of (UINT32) TPMA_PERMANENT Bits (BitsTable)
TPM_RC
...
// Table 2:35 - Definition of (UINT32) TPMA_STARTUP_CLEAR Bits (BitsTable)
TPM_RC
...
// Table 2:36 - Definition of (UINT32) TPMA_MEMORY Bits (BitsTable)
TPM_RC
...
// Table 2:37 - Definition of (TPM_CC) TPMA_CC Bits (BitsTable)
TPM_RC
TPMA_CC_Unmarshal(
    TPMA_CC *target, BYTE **buffer, INT32 *size)
{
    TPM_RC rc;
    rc = TPM_CC_Unmarshal((TPM_CC *)target, buffer, size);

    if(rc == TPM_RC_SUCCESS)
        if(*((TPM_CC *)target) & (TPM_CC)0x3f0000)
            rc = TPM_RC_RESERVED_BITS;
...
// Table 2:38 - Definition of (UINT32) TPMA_MODES Bits (BitsTable)
TPM_RC
TPMA_MODES_Unmarshal(
    TPMA_MODES *target, BYTE **buffer, INT32 *size)
{
    TPM_RC rc;
    rc = UINT32_Unmarshal((UINT32 *)target, buffer, size);
...
// Table 2:41 - Definition of (TPM_HANDLE) TPMI_DH_PARENT Type (InterfaceTable)
TPM_RC
TPMI_DH_PARENT_Unmarshal(
    TPMI_DH_PARENT *target, BYTE **buffer, INT32 *size, BOOL allowNull)
{
    TPM_RC rc;
    rc = TPM_HANDLE_Unmarshal((TPM_HANDLE *)target, buffer, size);
...
// Table 2:42 - Definition of (TPM_HANDLE) TPMI_DH_PERSISTENT Type (InterfaceTable)
TPM_RC
...
// Table 2:43 - Definition of (TPM_HANDLE) TPMI_DH_ENTITY Type (InterfaceTable)
TPM_RC
...
// Table 2:44 - Definition of (TPM_HANDLE) TPMI_DH_PCR Type (InterfaceTable)
TPM_RC
...
// Table 2:45 - Definition of (TPM_HANDLE) TPMI_SH_AUTH_SESSION Type (InterfaceTable)
TPM_RC
...
// Table 2:46 - Definition of (TPM_HANDLE) TPMI_SH_HMAC Type (InterfaceTable)
TPM_RC
...
// Table 2:47 - Definition of (TPM_HANDLE) TPMI_SH_POLICY Type (InterfaceTable)
TPM_RC
...
// Table 2:48 - Definition of (TPM_HANDLE) TPMI_DH_CONTEXT Type (InterfaceTable)
TPM_RC
...
// Table 2:49 - Definition of (TPM_HANDLE) TPMI_RH_HIERARCHY Type (InterfaceTable)
TPM_RC
...
// Table 2:50 - Definition of (TPM_HANDLE) TPMI_RH_ENABLES Type (InterfaceTable)
TPM_RC
...
// Table 2:51 - Definition of (TPM_HANDLE) TPMI_RH_HIERARCHY_AUTH Type (InterfaceTable)
TPM_RC
...
// Table 2:52 - Definition of (TPM_HANDLE) TPMI_RH_PLATFORM Type (InterfaceTable)
TPM_RC
...
// Table 2:53 - Definition of (TPM_HANDLE) TPMI_RH_OWNER Type (InterfaceTable)
TPM_RC
...
// Table 2:54 - Definition of (TPM_HANDLE) TPMI_RH_ENDORSEMENT Type (InterfaceTable)
TPM_RC
...
// Table 2:55 - Definition of (TPM_HANDLE) TPMI_RH_PROVISION Type (InterfaceTable)
TPM_RC
...
// Table 2:56 - Definition of (TPM_HANDLE) TPMI_RH_CLEAR Type (InterfaceTable)
TPM_RC
...
// Table 2:57 - Definition of (TPM_HANDLE) TPMI_RH_NV_AUTH Type (InterfaceTable)
TPM_RC
...
// Table 2:58 - Definition of (TPM_HANDLE) TPMI_RH_LOCKOUT Type (InterfaceTable)
TPM_RC
...
// Table 2:59 - Definition of (TPM_HANDLE) TPMI_RH_NV_INDEX Type (InterfaceTable)
TPM_RC
...
// Table 2:60 - Definition of (TPM_ALG_ID) TPMI_ALG_HASH Type (InterfaceTable)
TPM_RC
...
// Table 2:61 - Definition of (TPM_ALG_ID) TPMI_ALG_ASYM Type (InterfaceTable)
TPM_RC
...
// Table 2:62 - Definition of (TPM_ALG_ID) TPMI_ALG_SYM Type (InterfaceTable)
TPM_RC
...
// Table 2:63 - Definition of (TPM_ALG_ID) TPMI_ALG_SYM_OBJECT Type (InterfaceTable)
TPM_RC
...
// Table 2:64 - Definition of (TPM_ALG_ID) TPMI_ALG_SYM_MODE Type (InterfaceTable)
TPM_RC
...
// Table 2:65 - Definition of (TPM_ALG_ID) TPMI_ALG_KDF Type (InterfaceTable)
TPM_RC
...
// Table 2:66 - Definition of (TPM_ALG_ID) TPMI_ALG_SIG_SCHEME Type (InterfaceTable)
TPM_RC
...
// Table 2:67 - Definition of (TPM_ALG_ID){ECC} TPMI_ECC_KEY_EXCHANGE Type (InterfaceTable)
#ifdef TPM_ALG_ECC
TPM_RC
...
// Table 2:68 - Definition of (TPM_ST) TPMI_ST_COMMAND_TAG Type (InterfaceTable)
TPM_RC
...
// TPM2B_DIGEST definition used from Table 2:73
...
{
    UINT16 written = 0;
    written += TPM_PT_PCR_Marshal((TPM_PT_PCR*)&(source->tag), buffer, size );
    written += UINT8_Marshal((UINT8*)&(source->sizeofSelect), buffer, size );
    written += BYTE_Array_Marshal((BYTE*)(source->pcrSelect), buffer, size , (INT32)(source->sizeofSelect));
    return written;
}
...
// TPMS_TAGGED_POLICY_Unmarshal not required
UINT16
TPMS_TAGGED_POLICY_Marshal(
    TPMS_TAGGED_POLICY *source, BYTE **buffer, INT32 *size)
{
    UINT16 written = 0;
    written += TPM_HANDLE_Marshal((TPM_HANDLE*)&(source->handle), buffer, size );
    written += TPMT_HA_Marshal((TPMT_HA*)&(source->policyHash), buffer, size );
    return written;
}
...
// Table 2:107 - Definition of {ECC} TPML_ECC_CURVE Structure (StructureTable)
#ifdef TPM_ALG_ECC
...
// TPML_TAGGED_POLICY_Unmarshal not required
UINT16
TPML_TAGGED_POLICY_Marshal(
    TPML_TAGGED_POLICY *source, BYTE **buffer, INT32 *size)
{
    UINT16 written = 0;
    written += UINT32_Marshal((UINT32*)&(source->count), buffer, size );
    written += TPMS_TAGGED_POLICY_Array_Marshal((TPMS_TAGGED_POLICY*)(source->policies), buffer, size , (INT32)(source->count));
    return written;
}
...
// Table 2:120 - Definition of (TPM_ST) TPMI_ST_ATTEST Type (InterfaceTable)
...
// Table 2:126 - Definition of {!ALG.S} (TPM_KEY_BITS) TPMI_!ALG.S_KEY_BITS Type (InterfaceTable)
...
TPM2B_LABEL_Unmarshal(
    TPM2B_LABEL *target, BYTE **buffer, INT32 *size)
{
    TPM_RC rc = TPM_RC_SUCCESS;
    if (rc == TPM_RC_SUCCESS)
    {
...
UINT16
TPM2B_LABEL_Marshal(
    TPM2B_LABEL *source, BYTE **buffer, INT32 *size)
{
    UINT16 written = 0;
    written += UINT16_Marshal((UINT16*)&(source->t.size), buffer, size );
    if(source->t.size == 0)
...
TPMS_DERIVE_Unmarshal(
    TPMS_DERIVE *target, BYTE **buffer, INT32 *size)
{
    TPM_RC rc = TPM_RC_SUCCESS;
    if (rc == TPM_RC_SUCCESS)
    {
        rc = TPM2B_LABEL_Unmarshal((TPM2B_LABEL*)&target->label, buffer, size );
    }
    if (rc == TPM_RC_SUCCESS)
    {
        rc = TPM2B_LABEL_Unmarshal((TPM2B_LABEL*)&target->context, buffer, size );
    }
    return rc;
}
...
UINT16
TPMS_DERIVE_Marshal(
    TPMS_DERIVE *source, BYTE **buffer, INT32 *size)
{
    UINT16 written = 0;
    written += TPM2B_LABEL_Marshal((TPM2B_LABEL*)&(source->label), buffer, size );
    written += TPM2B_LABEL_Marshal((TPM2B_LABEL*)&(source->context), buffer, size );
    return written;
}
...
TPM_RC
TPM2B_DERIVE_Unmarshal(
    TPM2B_DERIVE *target, BYTE **buffer, INT32 *size)
{
    TPM_RC rc = TPM_RC_SUCCESS;
    if (rc == TPM_RC_SUCCESS)
    {
...
UINT16
TPM2B_DERIVE_Marshal(
    TPM2B_DERIVE *source, BYTE **buffer, INT32 *size)
{
    UINT16 written = 0;
    written += UINT16_Marshal((UINT16*)&(source->t.size), buffer, size );
    if(source->t.size == 0)
...
// TPMU_SENSITIVE_CREATE_Unmarshal not required
// TPMU_SENSITIVE_CREATE_Marshal not required
    ...
    TPM2B_SENSITIVE_CREATE *target, BYTE **buffer, INT32 *size)
{
    ...
    if (rc == TPM_RC_SUCCESS)
    {
        rc = UINT16_Unmarshal((UINT16*)&target->size, buffer, size );
    }
// if size is zero, then the structure is a zero buffer
    if(target->size == 0)
        return TPM_RC_SIZE;
    ...
    if (rc == TPM_RC_SUCCESS)
    {
        rc = TPMS_SENSITIVE_CREATE_Unmarshal((TPMS_SENSITIVE_CREATE*)&target->sensitive, buffer, size );
    }
...
// Table 2:142 - Definition of {ECC} TPMS_SCHEME_ECDAA Structure (StructureTable)
#ifdef TPM_ALG_ECC
TPM_RC
...
// Table 2:143 - Definition of (TPM_ALG_ID) TPMI_ALG_KEYEDHASH_SCHEME Type (InterfaceTable)
TPM_RC
...
// TPMS_SCHEME_HASH definition used from Table 2:141
...
TPMS_SCHEME_XOR_Unmarshal(
    TPMS_SCHEME_XOR *target, BYTE **buffer, INT32 *size)
{
    TPM_RC rc = TPM_RC_SUCCESS;
    if (rc == TPM_RC_SUCCESS)
    {
        rc = TPMI_ALG_HASH_Unmarshal((TPMI_ALG_HASH*)&target->hashAlg, buffer, size , 1);
    }
    if (rc == TPM_RC_SUCCESS)
    {
        rc = TPMI_ALG_KDF_Unmarshal((TPMI_ALG_KDF*)&target->kdf, buffer, size , 1);
    }
    return rc;
}
...
// Table 2:148 - Definition of {RSA} Types for RSA Signature Schemes (TypedefTable)
#ifdef TPM_ALG_RSA
// TPMS_SCHEME_HASH definition used from Table 2:141
...
// Table 2:149 - Definition of {ECC} Types for ECC Signature Schemes (TypedefTable)
#ifdef TPM_ALG_ECC
// TPMS_SCHEME_HASH definition used from Table 2:141
...
#ifdef TPM_ALG_ECC
// TPMS_SCHEME_ECDAA definition used from Table 2:142
...
// Table 2:152 - Definition of Types for {RSA} Encryption Schemes (TypedefTable)
#ifdef TPM_ALG_RSA
// TPMS_SCHEME_HASH definition used from Table 2:141
...
#ifdef TPM_ALG_RSA
// TPMS_EMPTY definition used from Table 2:69
...
// Table 2:153 - Definition of Types for {ECC} ECC Key Exchange (TypedefTable)
#ifdef TPM_ALG_ECC
// TPMS_SCHEME_HASH definition used from Table 2:141
...
// Table 2:157 - Definition of (TPM_ALG_ID) TPMI_ALG_ASYM_SCHEME Type (InterfaceTable)
...
// Table 2:160 - Definition of (TPM_ALG_ID) {RSA} TPMI_ALG_RSA_SCHEME Type (InterfaceTable)
#ifdef TPM_ALG_RSA
TPM_RC
...
// Table 2:161 - Definition of {RSA} TPMT_RSA_SCHEME Structure (StructureTable)
#ifdef TPM_ALG_RSA
TPM_RC
...
// Table 2:162 - Definition of (TPM_ALG_ID) {RSA} TPMI_ALG_RSA_DECRYPT Type (InterfaceTable)
#ifdef TPM_ALG_RSA
TPM_RC
...
// Table 2:163 - Definition of {RSA} TPMT_RSA_DECRYPT Structure (StructureTable)
#ifdef TPM_ALG_RSA
TPM_RC
...
// Table 2:164 - Definition of {RSA} TPM2B_PUBLIC_KEY_RSA Structure (StructureTable)
#ifdef TPM_ALG_RSA
TPM_RC
...
// Table 2:165 - Definition of {RSA} (TPM_KEY_BITS) TPMI_RSA_KEY_BITS Type (InterfaceTable)
#ifdef TPM_ALG_RSA
TPM_RC
...
// Table 2:166 - Definition of {RSA} TPM2B_PRIVATE_KEY_RSA Structure (StructureTable)
#ifdef TPM_ALG_RSA
TPM_RC
...
// Table 2:168 - Definition of {ECC} TPMS_ECC_POINT Structure (StructureTable)
#ifdef TPM_ALG_ECC
TPM_RC
...
// Table 2:169 - Definition of {ECC} TPM2B_ECC_POINT Structure (StructureTable)
#ifdef TPM_ALG_ECC
TPM_RC
...
// if size is zero, then the structure is a zero buffer
    ...
    if (rc == TPM_RC_SUCCESS)
    {
        rc = TPMS_ECC_POINT_Unmarshal((TPMS_ECC_POINT*)&target->point, buffer, size );
    }
    ...
    TPM2B_ECC_POINT *source, BYTE **buffer, INT32 *size)
{
    ...
    *buffer += 2;
    written += TPMS_ECC_POINT_Marshal((TPMS_ECC_POINT*)&(source->point), buffer, size );
...
// Table 2:170 - Definition of (TPM_ALG_ID) {ECC} TPMI_ALG_ECC_SCHEME Type (InterfaceTable)
#ifdef TPM_ALG_ECC
TPM_RC
...
// Table 2:171 - Definition of {ECC} (TPM_ECC_CURVE) TPMI_ECC_CURVE Type (InterfaceTable)
#ifdef TPM_ALG_ECC
TPM_RC
...
// Table 2:172 - Definition of (TPMT_SIG_SCHEME) {ECC} TPMT_ECC_SCHEME Structure (StructureTable)
#ifdef TPM_ALG_ECC
TPM_RC
...
// Table 2:173 - Definition of {ECC} TPMS_ALGORITHM_DETAIL_ECC Structure (StructureTable)
#ifdef TPM_ALG_ECC
...
// Table 2:174 - Definition of {RSA} TPMS_SIGNATURE_RSA Structure (StructureTable)
#ifdef TPM_ALG_RSA
TPM_RC
...
// Table 2:175 - Definition of Types for {RSA} Signature (TypedefTable)
#ifdef TPM_ALG_RSA
// TPMS_SIGNATURE_RSA definition used from Table 2:174
...
// Table 2:176 - Definition of {ECC} TPMS_SIGNATURE_ECC Structure (StructureTable)
#ifdef TPM_ALG_ECC
TPM_RC
...
// Table 2:177 - Definition of Types for {ECC} TPMS_SIGNATURE_ECC (TypedefTable)
#ifdef TPM_ALG_ECC
// TPMS_SIGNATURE_ECC definition used from Table 2:176
...
// Table 2:182 - Definition of (TPM_ALG_ID) TPMI_ALG_PUBLIC Type (InterfaceTable)
TPM_RC
...
// Table 2:186 - Definition of {RSA} TPMS_RSA_PARMS Structure (StructureTable)
#ifdef TPM_ALG_RSA
TPM_RC
...
// Table 2:187 - Definition of {ECC} TPMS_ECC_PARMS Structure (StructureTable)
#ifdef TPM_ALG_ECC
TPM_RC
...
// if size is zero, then the structure is a zero buffer
    ...
    if (rc == TPM_RC_SUCCESS)
    {
        rc = TPMT_PUBLIC_Unmarshal((TPMT_PUBLIC*)&target->publicArea, buffer, size , allowNull);
    }
    ...
    TPM2B_PUBLIC *source, BYTE **buffer, INT32 *size)
{
    ...
    BYTE *sizeField = *buffer;
    *buffer += 2;
    written += TPMT_PUBLIC_Marshal((TPMT_PUBLIC*)&(source->publicArea), buffer, size );
    written += UINT16_Marshal(&written, &sizeField, size);
    return written;
}
...
TPM2B_TEMPLATE_Unmarshal(
    TPM2B_TEMPLATE *target, BYTE **buffer, INT32 *size)
{
    TPM_RC rc = TPM_RC_SUCCESS;
    if (rc == TPM_RC_SUCCESS)
    {
...
UINT16
TPM2B_TEMPLATE_Marshal(
    TPM2B_TEMPLATE *source, BYTE **buffer, INT32 *size)
{
    UINT16 written = 0;
    written += UINT16_Marshal((UINT16*)&(source->t.size), buffer, size );
    if(source->t.size == 0)
...
// if size is zero, then the structure is a zero buffer
    ...
    if (rc == TPM_RC_SUCCESS)
    {
        rc = TPMT_SENSITIVE_Unmarshal((TPMT_SENSITIVE*)&target->sensitiveArea, buffer, size );
    }
...
{
    UINT16 written = 0;
    written += UINT16_Marshal((UINT16*)&(source->size), buffer, size );
    if(source->size == 0)
        return written;

    written += TPMT_SENSITIVE_Marshal((TPMT_SENSITIVE*)&(source->sensitiveArea), buffer, size );
    return written;
}
...
// TPMS_ID_OBJECT_Unmarshal not required
// TPMS_ID_OBJECT_Marshal not required
...
// Table 2:201 - Definition of (UINT32) TPM_NV_INDEX Bits (BitsTable)
...
// TPM_NT_Unmarshal not required
// TPM_NT_Marshal not required
    ...
    TPMS_NV_PIN_COUNTER_PARAMETERS *target, BYTE **buffer, INT32 *size)
{
    ...
    if (rc == TPM_RC_SUCCESS)
    {
        rc = UINT32_Unmarshal((UINT32*)&target->pinCount, buffer, size );
    }
    if (rc == TPM_RC_SUCCESS)
    {
        rc = UINT32_Unmarshal((UINT32*)&target->pinLimit, buffer, size );
    }
    return rc;
}
...
{
    UINT16 written = 0;
    written += UINT32_Marshal((UINT32*)&(source->pinCount), buffer, size );
    written += UINT32_Marshal((UINT32*)&(source->pinLimit), buffer, size );
    return written;
}


// Table 2:204 - Definition of (UINT32) TPMA_NV Bits (BitsTable)
TPM_RC
TPMA_NV_Unmarshal(
    TPMA_NV *target, BYTE **buffer, INT32 *size)
{
    ...
    if(rc == TPM_RC_SUCCESS)
        if(*((UINT32 *)target) & (UINT32)0x1f00300)
            rc = TPM_RC_RESERVED_BITS;
...
// if size is zero, then the structure is a zero buffer
    ...
    if (rc == TPM_RC_SUCCESS)
    {
        rc = TPMS_NV_PUBLIC_Unmarshal((TPMS_NV_PUBLIC*)&target->nvPublic, buffer, size );
    }
    ...
    TPM2B_NV_PUBLIC *source, BYTE **buffer, INT32 *size)
{
    ...
    BYTE *sizeField = *buffer;
    *buffer += 2;
    written += TPMS_NV_PUBLIC_Marshal((TPMS_NV_PUBLIC*)&(source->nvPublic), buffer, size );
    written += UINT16_Marshal(&written, &sizeField, size);
    return written;
}
    ...
    TPM2B_CREATION_DATA *source, BYTE **buffer, INT32 *size)
{
    ...
    BYTE *sizeField = *buffer;
    *buffer += 2;
    written += TPMS_CREATION_DATA_Marshal((TPMS_CREATION_DATA*)&(source->creationData), buffer, size );
    written += UINT16_Marshal(&written, &sizeField, size);
    return written;
}
...
// TPMS_TAGGED_POLICY_Array_Unmarshal not required
UINT16
    ...
    TPMS_TAGGED_POLICY *source, BYTE **buffer, INT32 *size, INT32 count)
{
    ...
    for(i = 0; i < count; i++)   // loop to process given amount of values
    {
        rc = (UINT16)(rc + TPMS_TAGGED_POLICY_Marshal(&source[i], buffer, size));
    }
    return rc;
}
