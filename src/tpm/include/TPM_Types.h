...
#define TPM_SPEC_VERSION (TPM_SPEC)(138)
#define TPM_SPEC_YEAR (TPM_SPEC)(2016)
#define TPM_SPEC_DAY_OF_YEAR (TPM_SPEC)(273)
...
// Table 2:12 - Definition of TPM_CC Constants (EnumTable)
...
// Table 2:69 - Definition of TPMS_EMPTY Structure (StructureTable)
...
#ifdef TPM_CAP_AUTH_POLICIES
    TPML_TAGGED_POLICY authPolicies;
#endif   // TPM_CAP_AUTH_POLICIES
} TPMU_CAPABILITIES;
...
// Table 2:126 - Definition of TPMI_!ALG.S_KEY_BITS Type (InterfaceTable)
#ifdef TPM_ALG_AES
