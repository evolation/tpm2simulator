...
// Function returns the number of Miller-Rabin rounds necessary to give an error probability
// equal to the
...
// iterations trials on the number. In all
...
// checked to see if it is divisible by the public exponent, then the number is adjusted either up or
// down in
...
// Function to generate a prime of the desired size with the proper attributes for
// an RSA prime.
void
