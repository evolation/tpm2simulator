...
// Convert an TPM2B to a BIG_NUM. If the input value does not exist, or the
...
// Function to create a BIG_POINT structure from a 2B point. A point is going to be two ECC values in
// the
