...
// This function will initialize the data structures for testing all the algorithms. This should
// not be called
...
// g_toTest is CLEAR. There is a special case for the call to TestAlgorithm().
// When alg is
