...
// This function is used to initialize an allocated bigNum with a word value. The bigNum
// does not have to be
...
// This function initializes a stack allocated bignum_t. It initializes allocated and size and
// zeros the words of
...
// Function to copy a bignum_t. If the output is NULL, then nothing happens. If the
// input is NULL, the output
