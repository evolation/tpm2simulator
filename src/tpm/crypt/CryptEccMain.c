...
// This function returns the number of the i-th implemented curve. The normal use would be to
// call this

// function with i starting at 0. When the i is greater than or equal to the number of implemented
// curves,
...
// This function returns an ECC curve parameter. The parameter is selected by a single
// character
...
// be the case when the values were created by the CryptoEngine() code. It
// will return
