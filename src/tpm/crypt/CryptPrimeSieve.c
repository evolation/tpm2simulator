...
// This function finds the nth SET bit in a bit array. The n parameter is between 1 and the
// number of bits in

// the array (always a multiple of 8). If called when the array does not have n bits set, it will
// return -1
