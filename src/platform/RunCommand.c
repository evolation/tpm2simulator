...
// is used to call to ExecuteCommand() in the TPM code. This function does whatever
// processing is

// necessary to set up the platform in anticipation of the call to the TPM including settup for
// error
