...
// Function: Move a chunk of NV memory from source to destination This function should ensure
// that if
...
// Set the current NV state to available. This function is for testing purpose only. It is not part
// of the
...
// Set the current NV state to unavailable. This function is for testing purpose only. It is not part
// of the
